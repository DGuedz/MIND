# Execução de posições alavancadas em looping

## Diagnóstico
**Contexto Operacional:** Execução de posições alavancadas em looping (Marginfi).
...
export async function executeSkill(intentPayload: any, agentPubkey: PublicKey) {
    ...
    console.log("Executando: Execução de posições alavancadas em looping...");
