...
export function InfrastructurePage() {
  return (
    <div className="container mx-auto px-6 pt-48 pb-32 space-y-32">
      ...
      <section className="bg-white/[0.02] border border-white/20 p-12 lg:p-20 rounded-[3rem] relative overflow-hidden group">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {[
          ...
          <div key={i} className="bg-white/[0.02] border border-white/20 p-12 rounded-[2.5rem] group hover:border-white/30 transition-all duration-700">
