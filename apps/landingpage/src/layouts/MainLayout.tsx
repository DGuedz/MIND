          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 text-sm max-w-sm mb-6">
                Secure intent rail for Solana agents: policy checks, human approval, execution, and verifiable proof.
              </p>
              <div className="flex items-center gap-4">
                <a href="https://github.com/DGuedz/MIND" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:border-white/30 transition-all">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><a href="https://github.com/DGuedz/MIND/tree/main/apps/api-gateway" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">API Reference</a></li>
                ...
                <li><a href="https://github.com/DGuedz/MIND/blob/main/governance/HACKATHON_VIDEO_SCRIPT.md" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Hackathon Guide</a></li>
              </ul>
            </div>
          </div>
